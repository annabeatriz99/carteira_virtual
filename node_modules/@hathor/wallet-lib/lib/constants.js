...
const WALLET_SERVICE_AUTH_DERIVATION_PATH = `m/${HATHOR_BIP44_CODE}'/${HATHOR_BIP44_CODE}'`;
/**
...
exports.WALLET_SERVICE_AUTH_DERIVATION_PATH = WALLET_SERVICE_AUTH_DERIVATION_PATH;
...
const P2SH_ACCT_PATH = `m/45'/${HATHOR_BIP44_CODE}'/0'`;
exports.P2SH_ACCT_PATH = P2SH_ACCT_PATH;