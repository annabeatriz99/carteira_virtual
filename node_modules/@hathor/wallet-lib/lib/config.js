...
exports.DEFAULT_SERVER = 'https://node1.mainnet.hathor.network/v1a/';
...
class Config {
    ...
    */
    ...
    getTxMiningUrl() {
        ...
        if (network_1.default.name == 'mainnet') {
            return TX_MINING_MAINNET_URL;
        }
        else if (network_1.default.name == 'testnet') {
            return TX_MINING_TESTNET_URL;
        }
        else {
            throw new Error(`Network ${network_1.default.name} doesn't have a correspondent tx mining service url. You should set it explicitly.`);
        }
    }
    /**
    ...
    */
    ...
    getWalletServiceBaseUrl() {
        if (!this.WALLET_SERVICE_BASE_URL) {
            throw new errors_1.GetWalletServiceUrlError('Wallet service base URL not set.');
        }
    ...
    getWalletServiceBaseWsUrl() {
        if (!this.WALLET_SERVICE_BASE_WS_URL) {
            throw new errors_1.GetWalletServiceWsUrlError('Wallet service base WebSocket URL not set.');
        }
    ...
    */
    ...
    getServerUrl() {
        ...
        if (storage_1.default.isInitialized()) {
            const server = storage_1.default.getItem('wallet:server');
            const defaultServer = storage_1.default.getItem('wallet:defaultServer');
            if (server !== null) {
                return server;
            }
