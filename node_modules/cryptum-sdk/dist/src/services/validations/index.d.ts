...
export function validateTransferTransactionParams(input: any): void;
...
export function validateHathorTokenTransactionFromWallet({ wallet, tokenUid, tokenName, tokenSymbol, address, changeAddress, mintAuthorityAddress, meltAuthorityAddress, amount, type, nftData, }: {
    wallet: any;
    tokenUid: any;
    tokenName: any;
    tokenSymbol: any;
...
export function validateWalletNft({ address, protocol, tokenAddresses }: {
    address: any;
    protocol: any;
    tokenAddresses: any;
}): void;
