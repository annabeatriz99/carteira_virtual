...
const validateEthereumTransferTransactionParams = ({ wallet, tokenSymbol, amount, destination, fee, testnet, contractAddress, }) => {
    if (!wallet) {
...
const validateCeloTransferTransactionParams = ({ wallet, tokenSymbol, amount, destination, memo, fee, testnet, contractAddress, feeCurrency, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (tokenSymbol && typeof tokenSymbol !== 'string') {
...
const validateSmartContractDeployTransactionParams = ({ wallet, fee, testnet, source, contractName, params, feeCurrency, protocol, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (fee && (!fee.gas || !fee.gasPrice)) {
...
const validateHathorTokenTransactionFromWallet = ({ wallet, tokenUid, tokenName, tokenSymbol, address, changeAddress, mintAuthorityAddress, meltAuthorityAddress, amount, type, nftData, }) => {
    if (!wallet) {
        throw new GenericException('Parameter wallet is null', 'InvalidTypeException');
    }
    if (![
...
const validateHathorTokenTransactionFromUTXO = ({ inputs, tokenUid, tokenName, tokenSymbol, address, changeAddress, mintAuthorityAddress, meltAuthorityAddress, amount, type, }) => {
    if (!inputs) {
        throw new GenericException('Parameter inputs is null', 'InvalidTypeException');
    }
    if (inputs && (!Array.isArray(inputs) || !inputs.length)) {
...
const validateStellarTransferTransactionParams = ({ wallet, assetSymbol, issuer, amount, destination, memo, fee, testnet, createAccount, timeout, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
...
const validateRippleTransferTransactionParams = ({ wallet, assetSymbol, issuer, amount, destination, memo, fee, testnet, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (fee && typeof fee !== 'string') {
...
const validateStellarTrustlineTransactionParams = ({ wallet, assetSymbol, issuer, fee, limit, memo, timeout, testnet, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (fee && typeof fee !== 'string') {
