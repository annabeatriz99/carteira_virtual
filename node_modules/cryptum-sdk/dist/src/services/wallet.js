...
const getSolanaDerivationPath = ({ account = 0, address }) => getDerivationPath({ purpose: 44, coin: 501, account, address });
/**
...
module.exports.deriveBitcoinWalletFromDerivationPath = async (mnemonic, testnet, { account = 0, change = 0, address } = {}) => {
    ...
    const derivedPath = hdPrivateKey.deriveChild(testnet
 ...
 * @returns
 */
module.exports.derivePolygonAddressFromXpub = async (xpub, { address = 0 } = {}) => this.deriveEthereumAddressFromXpub(xpub, { address });
/**
