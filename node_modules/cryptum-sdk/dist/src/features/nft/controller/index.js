...
const { ERC721_APPROVE_METHOD_ABI, ERC1155_SETAPPROVALLFORALL_METHOD_ABI, } = require('../../../services/blockchain/contract/abis');
const { validateEvmNftTransfer, validateEvmTokenCreation, validateEvmNftMint, validateEvmNftBurn } = require('../../../services/validations/evm');
...
class Controller extends Interface {
     ...
     */
    async create(input) {
        const { protocol, wallet, symbol, name, amount, uri, mintAuthorityAddress, meltAuthorityAddress, creators, royaltiesFee, collection, maxSupply, feeCurrency, type, fee } = input;
