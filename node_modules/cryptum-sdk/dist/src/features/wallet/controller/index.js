...
const { getBitcoinAddressFromPrivateKey, getBscAddressFromPrivateKey, getEthereumAddressFromPrivateKey, getCeloAddressFromPrivateKey, getStellarPublicKeyFromPrivateKey, getRippleAddressFromPrivateKey, getAvalancheAddressFromPrivateKey, getPolygonAddressFromPrivateKey, getSolanaAddressFromPrivateKey, deriveBitcoinWalletFromDerivationPath, deriveCeloWalletFromDerivationPath, deriveStellarWalletFromDerivationPath, deriveRippleWalletFromDerivationPath, deriveEthereumWalletFromDerivationPath, deriveBitcoinAddressFromXpub, deriveBscAddressFromXpub, deriveEthereumAddressFromXpub, deriveCeloAddressFromXpub, deriveHathorWalletFromDerivationPath, getHathorAddressFromPrivateKey, deriveHathorAddressFromXpub, deriveCardanoWalletFromDerivationPath, deriveCardanoAddressFromXpub, getCardanoAddressFromPrivateKey, deriveAvalancheAddressFromXpub, derivePolygonAddressFromXpub, deriveSolanaWalletFromDerivationPath, } = require('../../../services/wallet');
...
class Controller extends Interface {
    ...
    async getWalletInfo(input) {
        ...
        return new WalletInfoResponse(await makeRequest({ method: 'get', url: `/wallet/${address}/info?${qs.join('&')}`, config: this.config }));
    }
    /**
    ...
    async getWalletNft(input) {
        ...
        const qs = [`protocol=${protocol}`];
        return new WalletInfoResponse(await makeRequest({ method: 'get', url: `/wallet/${address}/nft?${qs.join('&')}`, config: this.config }));
    }
}
