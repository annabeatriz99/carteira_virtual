...
class Controller extends Interface {
    ...
    async deploy(input) {
        ...
        return await tc.sendTransaction(new SignedTransaction({
   ...
   */
    async createLootBox(input) {
        ...
        const { protocol, contents, wallet, lootBoxAddress, lootBoxURI, openStartTimestamp, recipient, amountDistributedPerOpen, rewardUnits } = input;
        const data = {
            from: wallet.address,
            contents,
        ...
        (_a = data.contents) === null || _a === void 0 ? void 0 : _a.forEach((r => {
